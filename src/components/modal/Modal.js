    ...
    <div className="modal" id='modal__animation'>
        <div className="modal__content">
                ...
                <div className="modal__body">
                    ...
                    <form>
                        <div className="form__group field modal__city">
                            <input type="input" className="form__field" placeholder="City" name="city" id='city' required />
                            <label htmlFor="city" className="form__label">City</label>
                        </div>
                        
                        <div className="form__group field modal__country">
                            <input type="input" className="form__field" placeholder="Country" name="country" id='country' required />
            ...
            <div className="modal__footer">
                    ...
                    <a href="#" className="modal__btn modal__btn--clear" ><BsTrash className='btn--clear__icon'/>Remove</a>
